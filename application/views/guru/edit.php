<section class="content">
        ...
        // FORM OPEN
        echo form_open(base_url('guru/edit/'.$guru->id_guru), $atribut);
        ?>
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">                          
                            <form class="form-horizontal" action="<?= base_url('guru/edit/'.$guru->id_guru)?>" method="post">
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input name="nip" type="text" class="form-control" placeholder="Nip" value="<?php echo $guru->nip ?>" required>
                                            </div>
                                            <?php 
                                                // var_dump($guru);
                                                // exit();
                                  ...
                                  <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input name="nama" type="text" class="form-control" placeholder="Nama Guru" value="<?php echo $guru->nama ?>" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input name="alamat" type="text" class="form-control" placeholder="Alamat" value="<?php echo $guru->alamat ?>" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row clearfix">
                                 ...
                                 <!--  <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input name="jk" type="text" class="form-control" placeholder="Jenis Kelamin" value="<?php echo $guru->jk ?>" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>  -->
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input name="username" type="text" class="form-control" placeholder="Username" value="<?php echo $guru->username ?>" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input name="password" type="text" class="form-control" placeholder="Password" value="<?php echo $guru->password ?>" required>
                                            </div>
                                        </div>
                                    </div>
                                </div> 
                               ...
                               <!--  <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input name="no_telp" type="text" class="form-control" placeholder="No Telp" value="<?php echo $guru->no_telp ?>" required>
                                            </div>
                                        </div>
                                    </div>
                                </div> -->
