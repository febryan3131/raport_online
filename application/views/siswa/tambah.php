<section class="content">
        ...
        // FORM OPEN
        echo form_open(base_url('siswa/tambah'), $atribut);
        ?>
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">                          
                            <form class="form-horizontal" action="<?=base_url('siswa/tambah');?>" method="post">
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input name="nis" type="text" class="form-control" placeholder="NIS" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
