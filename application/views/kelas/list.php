         ...
         <ol class="breadcrumb">
                ...
                <li class="active">
                    <a href="<?=base_url('kelas');?>">
                        <i class="material-icons">account_balance</i> Kelas
                    </a>
                </li>
        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    ...
                    <a class="btn btn-success btn-md" href="<?=base_url('kelas/tambah');?>">
                            ...
                            <tbody>
                                ...
                                foreach($kelas as $kelas){ 
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-warning" href="<?= base_url('kelas/edit/'.$kelas->id_kelas)?>">Edit</a>
