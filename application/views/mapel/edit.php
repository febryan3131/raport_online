...
<section class="content">
        ...
        // FORM OPEN
        echo form_open(base_url('mapel/edit/'.$mapel->id_mapel), $atribut);
        ?>                                                                                                                                   
            <!-- Horizontal Layout -->
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">                          
                            <form class="form-horizontal" action="<?= base_url('mapel/edit/'.$mapel->id_mapel)?>" method="post">
                               <!--  <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input name="id_mapel" type="text" class="form-control" placeholder="Id Mapel" value="<?php echo $mapel->id_mapel ?>" required>
                                            </div>
                                            <?php 
                                                // var_dump($mapel);
                                                // exit();
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input name="nama_mapel" type="text" class="form-control" placeholder="Nama mapel" value="<?php echo $mapel->nama_mapel ?>" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                 ...
                                 <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                               ...
                                               <select name="keterangan" placehoder="-Pilih keterangan-"  value="<?php echo $mapel->keterangan ?>" required>>
                                ...
                                <!-- <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input name="semester" type="text" class="form-control" placeholder="semester" value="<?php echo $mapel->semester ?>" required>
                                            </div>
                                        </div>
                                    </div>
                                </div> -->
