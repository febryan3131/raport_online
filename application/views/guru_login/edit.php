<section class="content">
        <div class="container-fluid">
            <ol class="breadcrumb">
                ...
                <li>
                    <a href="<?=base_url('guru_login_login');?>">
        ...
        // FORM OPEN
        echo form_open(base_url('guru_login/edit/'.$nilai->id_nilai), $atribut);
        ?>
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">                          
                            <form class="form-horizontal" action="<?= base_url('guru_login_login/edit/'.$nilai->id_niali)?>" method="post">
                                  ...
                                  <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input name="nama" type="text" class="form-control" placeholder="Nama siswa" value="<?php echo $guru_login->siswa_id?>" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input name="semester" type="text" class="form-control" placeholder="Semester" value="<?php echo $guru_login->semester ?>" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input name="nama_mapel" type="text" class="form-control" placeholder="Mapel" value="<?php echo $guru_login->mapel_id ?>" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input name="nilai" type="text" class="form-control" placeholder="Nilai" value="<?php echo $guru_login->nilai ?>" required>
                                            </div>
                                        </div>
                                    </div>
                                </div> 
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                               ...
                                               <select name="keterangan" placehoder="-Pilih keterangan-">
                                ...
                                <div class="row clearfix">
                                    <div class="col-lg-2 col-md-2 col-sm-4 col-xs-5 form-control-label">
                                        <label>guru_login Bidang</label>
                                    </div>
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input name="guru_login_bidang" type="text" class="form-control" placeholder="guru_login Bidang" value="<?php echo $guru_login->guru_login_bidang ?>" required>
                                            </div>
                                        </div>
                                    </div>
                                </div> 
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input name="mapel_kode_mapel" type="text" class="form-control" placeholder="Kode Mapel" value="<?php echo $guru_login->mapel_kode_mapel ?>" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
