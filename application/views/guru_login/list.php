        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    ...
                    <a class="btn btn-success btn-md" href="<?=base_url('guru_login/tambah');?>">
                    ...
                    <div class="body table-responsive" id="cetakArea">
                        <table class="table table-condensed">
                            ...
                            <tbody>
                                <?php                                   
                                $i = 1; 
                                foreach($guru_login as $guru_login){ 
                                    ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-warning" href="<?= base_url('guru_login/edit/'.$nilai->id)?>">Edit</a>
