<section class="content">
        ...
        // FORM OPEN
        echo form_open(base_url('guru_login_login/tambah'), $atribut);
        ?>
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">                          
                            <form class="form-horizontal" action="<?=base_url('guru_login/tambah');?>" method="post">
                                <div class="row clearfix">
                                ...
                                <div class="row clearfix">
                                 ...
                                 <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input name="nama_mapel" type="text" class="form-control" placeholder="Mapel" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                               <select name="keterangan" placehoder="-Keterangan-" required>
                                                   ...
                                                   <option value="terlampaui">Terampaui</option>
                                               </select>
                                        </div>
                                    </div>
                                </div>
